...
#
###############################################################################
def turtle(thick, color):
    window = rg.TurtleWindow()
    somalia = rg.SimpleTurtle('turtle')
    somalia.pen = rg.Pen('green', thick)
    jabalpur = rg.SimpleTurtle('triangle')
    jabalpur.pen = rg.Pen(color, 5)
    somalia.forward(100)
    jabalpur.backward(100)
