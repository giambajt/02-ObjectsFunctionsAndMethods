...
def main():
    ...
    # -------------------------------------------------------------------------
    draw_circles(rg.Point(-100, -74))
    draw_circles(rg.Point(250, 200))
    better_draw_circles(rg.Point(100,50), 18)
    better_draw_circles(rg.Point(-200,0), 9)
    even_better_draw_circles(rg.Point(300,75), 7, 8, 'blue',3)
    even_better_draw_circles(rg.Point(-100, -250), 13, 4, 'red',5)
    window.update()
...
def even_better_draw_circles(point, radius, number_of_circles, color, thickness):
