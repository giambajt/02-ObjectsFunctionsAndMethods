...
def try_methods():
    ...
    ###########################################################################
    bobert = rg.SimpleTurtle('turtle')
    bobert.pen = rg.Pen('brown', 5)
    bobert.forward(150)
    bobert.left(90)
    bobert.forward(50)
    bobert.backward(100)
...
def try_methods_and_functions():
    roxanne = rg.SimpleTurtle('turtle')
    roxanne.pen = rg.Pen('blue', 5)
    roxanne.backward(150)
    roxanne.speed = 1
    draw_many_squares(roxanne,2,100,30)
    roxanne.speed = 5
    roxanne.pen = rg.Pen('red', 5)
    draw_many_squares(roxanne,10,50,15)
    roxanne.speed = 100
    roxanne.pen = rg.Pen('red', 35)
    draw_many_squares(roxanne,8,300,60)
    roxanne.pen = rg.Pen('black', 3)
    roxanne.backward(200)
    roxanne.draw_circle(30)
    roxanne.draw_square(50)
    """
    Constructs a SimpleTurtle and sets its   pen  to a new rg.Pen
